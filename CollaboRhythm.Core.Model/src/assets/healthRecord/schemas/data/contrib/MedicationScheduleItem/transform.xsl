...
<xsl:if test="indivodoc:dose/indivodoc:value"><Field name="dose_value"><xsl:value-of select="indivodoc:dose/indivodoc:value"/></Field></xsl:if><xsl:if test="indivodoc:dose/indivodoc:textValue"><Field name="dose_textValue"><xsl:value-of select="indivodoc:dose/indivodoc:textValue"/></Field></xsl:if><xsl:if test="indivodoc:dose/indivodoc:unit"><Field name="dose_unit_text"><xsl:value-of select="indivodoc:dose/indivodoc:unit/text()"/></Field><xsl:if test="indivodoc:dose/indivodoc:unit/@type"><Field name="dose_unit_type"><xsl:value-of select="indivodoc:dose/indivodoc:unit/@type"/></Field></xsl:if><xsl:if test="indivodoc:dose/indivodoc:unit/@value"><Field name="dose_unit_value"><xsl:value-of select="indivodoc:dose/indivodoc:unit/@value"/></Field></xsl:if><xsl:if test="indivodoc:dose/indivodoc:unit/@abbrev"><Field name="dose_unit_abbrev"><xsl:value-of select="indivodoc:dose/indivodoc:unit/@abbrev"/></Field></xsl:if></xsl:if>
