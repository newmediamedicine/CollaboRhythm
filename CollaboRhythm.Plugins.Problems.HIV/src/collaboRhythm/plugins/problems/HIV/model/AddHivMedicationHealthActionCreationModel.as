package collaboRhythm.plugins.problems.HIV.model
{
	...
	public class AddHivMedicationHealthActionCreationModel extends EventDispatcher implements IHealthActionCreationModel
	{
		...
		private var _hivMedicationDoseArray:Array = [2, 4, 2, 1, 2, 1, 2, 1, 1, 1, 1, 2, 1, 1, 1, 1, 3, 1, 2, 2, 2, 1, 1, 2, 1, 1];
		private var _hivMedicationFrequencyArray:Array = [2, 2, 3, 2, 1, 1, 1, 1, 1, 2, 1, 2, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 2, 3, 1, 1];
		...
		private function createMedicationOrder(hivMedicationChoice:HIVMedicationChoice):MedicationOrder
		{
			...
			var doseUnit:CollaboRhythmCodedValue = codedValueFactory.createDoseUnitCodedValue(hivMedicationChoice.name.form);
