...
package collaboRhythm.shared.model.healthRecord
{
    ...
    public class MedicationScheduleItemsHealthRecordService extends PhaHealthRecordServiceBase
	{

		public function MedicationScheduleItemsHealthRecordService(consumerKey:String, consumerSecret:String, baseURL:String, account:Account)
		{
			super(consumerKey, consumerSecret, baseURL, account);
		}

        public function getMedicationScheduleItems(record:Record):void
        {
        ...
        {
            healthRecordServiceRequestDetails.record.medicationScheduleItemsModel.medicationScheduleItemsReportXml = responseXml;
        }
	}
}