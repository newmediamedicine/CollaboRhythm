...
package collaboRhythm.shared.model.healthRecord
{
    ...
    public class AdherenceItemsHealthRecordService extends PhaHealthRecordServiceBase
	{
        ...
        public function getAdherenceItems(record:Record):void
        {
            ...
            _pha.reports_minimal_X_GET(null, null, null, null, record.id, "adherenceitems", _activeAccount.oauthAccountToken, _activeAccount.oauthAccountTokenSecret, healthRecordServiceRequestDetails);
        }
        ...
        {
            healthRecordServiceRequestDetails.record.adherenceItemsModel.adherenceItemsReportXml = responseXml;
        }
	}
}
