...
package collaboRhythm.shared.model.healthRecord
{
    ...
    public class ProblemsHealthRecordService extends PhaHealthRecordServiceBase
	{
        ...
        public function getProblems(record:Record):void
        {
            ...
            _pha.reports_minimal_X_GET(null, null, null, null, record.id, "problems", _activeAccount.oauthAccountToken, _activeAccount.oauthAccountTokenSecret, healthRecordServiceRequestDetails);
        }
        ...
        {
            healthRecordServiceRequestDetails.record.problemsModel.problemsReportXml = responseXml;
        }
	}
}
