...
package collaboRhythm.shared.model.healthRecord
{
    ...
    public class EquipmentScheduleItemsHealthRecordService extends PhaHealthRecordServiceBase
	{

		public function EquipmentScheduleItemsHealthRecordService(consumerKey:String, consumerSecret:String, baseURL:String, account:Account)
		{
			super(consumerKey, consumerSecret, baseURL, account);
		}

        public function getEquipmentScheduleItems(record:Record):void
        {
        ...
        {
            healthRecordServiceRequestDetails.record.equipmentScheduleItemsModel.equipmentScheduleItemsReportXml = responseXml;
        }
	}
}
