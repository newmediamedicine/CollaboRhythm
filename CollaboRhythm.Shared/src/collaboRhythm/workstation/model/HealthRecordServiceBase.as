package collaboRhythm.workstation.model
{
	...
	[Event(name="loginComplete", type="collaboRhythm.workstation.model.HealthRecordServiceEvent")]
	[Event(name="complete", type="collaboRhythm.workstation.model.HealthRecordServiceEvent")]
