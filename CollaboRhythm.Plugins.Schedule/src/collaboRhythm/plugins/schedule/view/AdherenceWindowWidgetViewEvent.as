...
package collaboRhythm.plugins.schedule.view
{
	...
	public class AdherenceWindowWidgetViewEvent extends Event
	{
		...
		private var _widgetAdherenceWindowView:ScheduleGroupWidgetView;
		
		public function AdherenceWindowWidgetViewEvent(type:String, widgetAdherenceWindowView:ScheduleGroupWidgetView, bubbles:Boolean=false, cancelable:Boolean=false)
		{
			super(type, bubbles, cancelable);
			_widgetAdherenceWindowView = widgetAdherenceWindowView;
		}
		
		public function get widgetAdherenceWindowView():ScheduleGroupWidgetView
		{
