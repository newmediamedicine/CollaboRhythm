...
package collaboRhythm.shared.model.services
{
	...
	public class DateUtil
	{
		 ...
		 * @param returnNullIfEmpty Indicates that null should be returned instead of throwing an exception if dateString is null or empty
		 *
		...
		{
			return date && roundTimeToNextDay(date).valueOf() ==
