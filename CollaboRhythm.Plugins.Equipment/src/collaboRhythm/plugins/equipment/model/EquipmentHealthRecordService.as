package collaboRhythm.plugins.equipment.model
{
	...
	public class EquipmentHealthRecordService extends collaboRhythm.shared.model.healthRecord.HealthRecordServiceBase
	{
		...
		{			
			...
			{
				_pha.reports_minimal_X_GET(params, null, null, null, user.recordId, "equipment", accessKey, accessSecret, new ReportRequestDetails(user, "equipment"));
			}	
		}
		...
		private function handleEquipmentReport(user:User, equipmentModel:EquipmentModel, responseXML:XML):void
		{
			...
			_pha.reports_minimal_X_GET(params, null, null, null, user.recordId, "scheduleitems", accessKey, accessSecret, new ReportRequestDetails(user, "equipmentScheduleItems"));
		}
