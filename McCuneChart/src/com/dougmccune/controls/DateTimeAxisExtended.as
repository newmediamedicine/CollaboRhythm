...
//	public class DateTimeAxisExtended
	...
	/**
	 *  The DateTimeAxisExtended class maps time values evenly
	 ...
	 *
	 *  <p>The DateTimeAxisExtended chooses the most reasonable units
	 ...
	 *  By default, the DateTimeAxisExtended chooses the smallest possible range
	 ...
	 *  @mxml
	 *  
	 *  <p>The <code>&lt;mx:DateTimeAxisExtended&gt;</code> tag inherits all the properties
	 *  of its parent classes and adds the following properties:</p>
	 *  
	 *  <pre>
	 *  &lt;mx:DateTimeAxisExtended
	 ...
	 */
	public class DateTimeAxisExtended extends NumericAxis
	{
...
//			update();
		 ...
		 *  @productversion Flex 3
		 */
		public function DateTimeAxisExtended()
		{
			super();
		 ...
		 *  returns a Date object. The Date object is then used in the DateTimeAxisExtended 
		 *  object of the chart. This lets you provide customizable date input strings 
		 *  and convert them to Date objects, which Flex can then interpret for use in the DateTimeAxisExtended.
		 *  
		 ...
		 *  By default, the DateTimeAxisExtended uses the string parsing functionality
		 ...
		 *      &lt;mx:horizontalAxis&gt;
		 *          &lt;mx:DateTimeAxisExtended dataUnits="days" parseFunction="myParseFunction"/&gt;
		 *      &lt;/mx:horizontalAxis&gt;
		 *      &lt;mx:series&gt;
		 ...
		 *  a DateTimeAxisExtended does not choose any unit smaller
		 ...
		 *  their columns as days, but the DateTimeAxisExtended chooses
		 ...
		 *  a DateTimeAxisExtended considers all date values to be in the time zone
		 ...
		 *  By default, a DateTimeAxisExtended considers all valid units
		 ...
		 *  the DateTimeAxisExtended calculates it automatically.
		 *  
			...
			while (units != null)
			{
				...
				switch (units)
				{
					...
					case "years":                               
					{
						...
						if (max - min >= minimumLabelCount * labelInterval)
							validUnitFound=true;
					...
					case "weeks":
					{
						if (fromMilli(maxMilli - minMilli, "weeks") >=
							minimumLabelCount * labelInterval)
						{
							validUnitFound = true;
						}
		 ...
		 *  If you write a custom DateTimeAxisExtended class, you can override this method 
		 ...
		 *  
		 *  @param axis The DateTimeAxisExtended on which the label is rendered.
		 *  
		...
		protected function formatYears(d:Date, previousValue:Date,
									   axis:DateTimeAxisExtended):String
		{
		 ...
		 *  If you write a custom DateTimeAxisExtended class, you can override this method to 
		 ...
		 *  If you write a custom DateTimeAxisExtended class, you can override this method to provide 
