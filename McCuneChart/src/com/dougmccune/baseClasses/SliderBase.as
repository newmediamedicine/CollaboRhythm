...
//	include "../../core/Version.as";
	 ...
	 *  @private
	 */
	protected var trackHitArea:UIComponent;
	 ...
	 */
	protected var _thumbCount:int = 1;
	 ...
	 *  @private
	 */
	protected var _tickValues:Array = [];
...
//		      graphics.endFill();
	 ...
	 *  @private
	 */
	protected function getComponentBounds():Object
	{
		var isHorizontal:Boolean = (direction == SliderDirection.HORIZONTAL);
		var numLabels:int = labelObjects ? labelObjects.numChildren : 0;
		var labelY:Number;
	 ...
	 *  @private
	 */
	protected function layoutTicks():void
	{
		if (ticks)
		{
	 ...
	 *  @private
	 */
	protected function layoutLabels():void
	{
	 ...
	 */
	protected function setPosFromValue():void
	{
		var n:int = _thumbCount;
		for (var i:int = 0; i < n; i++)
		{
								...
								isProgrammatic:Boolean = false):void
	{
		...
		if (!isProgrammatic)
		{
			...
			if (!isNaN(oldValue))
			{
				// TODO: determine why we sometimes fail to dispatch this event (oldValue == value) even though the value does in fact change
				// Note that at the moment we are relying on this behavior in McCuneChart and we are explicitly dispatching an appropriate event after scrolling
