...
package collaboRhythm.plugins.postOpHome.controller
{
	...
	import collaboRhythm.plugins.postOpHome.view.PostOpEducationButtonWidgetView;
	import collaboRhythm.plugins.postOpHome.view.PostOpEducationView;
	...
	public class PostOpEducationAppController extends AppControllerBase
	{
		public static const DEFAULT_NAME:String = "PostOpEducation";

		private var _widgetView:PostOpEducationButtonWidgetView;
		private var _fullView:PostOpEducationView;

		private var _postOpHomeModel:PostOpHomeModel;

		public function PostOpEducationAppController(constructorParams:AppControllerConstructorParams)
		{
		...
		{
			_widgetView = new PostOpEducationButtonWidgetView();
			return _widgetView
		}

		override protected function createFullView():UIComponent
		{
			_fullView = new PostOpEducationView();
			return _fullView;
		}
		...
		{
			_widgetView = value as PostOpEducationButtonWidgetView;
		}
		...
		{
			_fullView = value as PostOpEducationView;
		}
		...
		override public function get isFullViewSupported():Boolean
			...
			public function openPostOpEducationView():void
			{
				_viewNavigator.pushView(PostOpEducationView, null, null, new SlideViewTransition());
			}
	}
}
