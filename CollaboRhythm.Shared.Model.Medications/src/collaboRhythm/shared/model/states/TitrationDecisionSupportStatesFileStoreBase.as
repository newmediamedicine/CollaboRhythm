 ...
 */
package collaboRhythm.shared.model.states
{
	...
	public class TitrationDecisionSupportStatesFileStoreBase implements ITitrationDecisionSupportStatesFileStore
	{
		[Embed("/assets/schemas/titrationDecisionSupportStates.xsd", mimeType="application/octet-stream")]
		...
		public function TitrationDecisionSupportStatesFileStoreBase()
		{
...
//					"titrationDecisionSupportStates"), TitrationDecisionSupportStates);
		...
		{
			_isLoaded = readTitrationDecisionSupportStatesFromEmbeddedFile(titrationDecisionSupportStatesEmbeddedFile);
		}
...
*/
		...
		public function get titrationDecisionSupportStatesEmbeddedFile():Class
		{
			// virtual function that should be overridden by subclasses
